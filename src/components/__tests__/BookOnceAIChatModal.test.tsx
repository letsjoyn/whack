/**
 * BookOnceAIChatModal Component Tests
 * Tests for the main chat modal component
 */

import { describe, it, expect, vi, beforeEach } from 'vitest';
import { render, screen, fireEvent, waitFor } from '@testing-library/react';
import { BookOnceAIChatModal } from '../BookOnceAIChatModal';
...
describe('BookOnceAIChatModal', () => {
  ...
  it('should not render when isOpen is false', () => {
    render(<BookOnceAIChatModal />);
    
    // Dialog should not be visible
    expect(screen.queryByText('BookOnce AI Assistant')).not.toBeInTheDocument();
  });
  ...
  it('should render when isOpen is true', () => {
    ...
    expect(screen.getByText('BookOnce AI Assistant')).toBeInTheDocument();
