              ...
              {places.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">
                    We couldn't find any endangered places near {destination}, but there are many others around the world that need your witness.
                  </p>
                      ...
                      <div className="flex">
                        ...
                        <div className="flex-1 p-4">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            {/* Threat Level Badge */}
                            <div className={`px-3 py-1 rounded-full border text-xs font-medium ${threatColors[place.threatLevel]}`}>
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50">
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-600">
                  💡 <strong>Tip:</strong> Book your main trip and add these endangered places as side visits
                </div>
