...
import { X, Star, Camera, MapPin, Shield, AlertTriangle, Send, Upload, User } from 'lucide-react';
...
export const CommunityReviewModal = ({
  isOpen,
  onClose,
  location,
  type,
                ...
                {submitted ? (
                  ...
                  <div className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground">
                      Thank you for contributing to our community. Your{' '}
                      {reviewType === 'place' ? 'review' : 'report'} helps keep everyone informed
                      and safe.
                    </p>
                  </div>
                ) : (
                    ...
                    <div className="p-6 border-b border-border">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-10 h-10 rounded-lg ${reviewType === 'place' ? 'bg-blue-500' : 'bg-orange-500'} flex items-center justify-center`}
                          >
                            {reviewType === 'place' ? (
                            ...
                            <RadioGroup value={category} onValueChange={setCategory}>
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="infrastructure">
                                  Poor Lighting or Infrastructure
                                </Label>
                              </div>
                              <div className="flex items-center space-x-2">
